...
const controlClasses =
  'w-full rounded-md border border-line-control bg-card px-3 text-sm text-fg placeholder:text-fg-subtle transition-colors duration-(--duration-fast) focus-visible:border-brand focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand/40 disabled:opacity-50 aria-invalid:border-critical aria-invalid:focus-visible:ring-critical/40';
