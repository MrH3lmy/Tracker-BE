...
public class NoteTemplateService {
    ...
    public NoteResponse createNoteFromTemplate(CreateNoteFromTemplateRequest request) {
        ...
        NoteResponse created = noteService.create(new CreateNoteRequest(title, body, NoteContentType.MARKDOWN, request.taskId(), null, null, null, null, null, null, null, null, null, null, request.tags()));
