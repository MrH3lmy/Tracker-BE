 ...
 * Increment-and-expire runs as a single Lua script so concurrent requests across instances can't
 * race past the limit the way two separate INCR/EXPIRE calls could.
 * <p>
...
public class RedisRateLimiter implements RateLimiter {
    ...
    // Keys can embed emails/IPs (see AuthRateLimitService) - never log them raw.
