...
public class TaskControllerV1 {
    ...
    @GetMapping("/{id}/detail") public TaskDetailResponse detail(@PathVariable Long id){ TaskResponse task = mapper.toResponse(taskService.findById(id)); return new TaskDetailResponse(task, noteService.findByTaskId(id), noteService.findTaskScreenshots(id)); }
